<template>
  <DynamicTable
    ...
    :data-request="Api.recordEs.esList"
    :columns="columns"
    bordered
    size="small"
  >
...
<script lang="ts" setup>
   ...
   * @description  Es连接测试
   */
  const esConnect = async (record: Partial<TableListItem>) => {
    if(record.id){
      await Api.recordEs.esConnect({id:record.id})
    }
  };
